...
{
    public class TS_BCDA_02H_TS_TSDA:BaseViewEntity
    {
        ...
        public decimal? dien_tich_ban { get; set; }
        public decimal? so_luong_dieu_chuyen { get; set; }
        public decimal? nguyen_gia_dieu_chuyen { get; set; }
        public decimal? dien_tich_dieu_chuyen { get; set; }
        public decimal? so_luong_thanh_ly { get; set; }
        public decimal? nguyen_gia_thanh_ly { get; set; }
        public decimal? dien_tich_thanh_ly { get; set; }
