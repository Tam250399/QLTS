create or replace FUNCTION GS_UPDATE_TSKHAC_32_TO_GSTEMP_DONG_BO 
(
...
bienDongJson := bienDongJson ||
    '{"GUID":"' || bienDongGuid || '",
    "NGUYEN_GIA":' || rtrim(to_char((
      r_bd_khac.NGUYEN_GIA_NS + r_bd_khac.NGUYEN_GIA_KHAC
    ), 'FM9999999999999999999999990.99'), '.')||',
...
nguonVonJson := nguonVonJson ||
    '{"NGUON_VON_ID":1,
    "GIA_TRI":' || rtrim(to_char(r_bd_khac.NGUYEN_GIA_NS, 'FM9999999999999999999999990.99'), '.')||',
    "BIEN_DONG_GUID":"' || bienDongGuid || '"},
  
    {"NGUON_VON_ID":3,
    "GIA_TRI":' || rtrim(to_char(r_bd_khac.NGUYEN_GIA_KHAC, 'FM9999999999999999999999990.99'), '.')||',
    "BIEN_DONG_GUID":"' || bienDongGuid || '"},';
hienTrangJson := hienTrangJson ||
    '{"HIEN_TRANG_ID":' || (
      case
...
--update lại temp đồng bộ
    ...
    commit;
  RETURN 1;
END GS_UPDATE_TSKHAC_32_TO_GSTEMP_DONG_BO;