create or replace FUNCTION DEL_TAI_SAN_DB_QLDKTS40 (
p_MA_QLDKTS40 VARCHAR2
)RETURN number AS 

BEGIN
  FOR r_product IN (
        SELECT * FROM TS_TAI_SAN where MA_QLDKTS40 = p_MA_QLDKTS40
    ) 
  LOOP
