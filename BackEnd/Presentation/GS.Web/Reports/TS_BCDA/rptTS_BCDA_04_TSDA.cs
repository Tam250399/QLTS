...
namespace GS.Web.Reports.TS_BCDA
{
    public partial class rptTS_BCDA_04_TSDA
    {
        ...
        {
            lblDonVi.Text = "Cơ quan báo cáo: " + _baoCaoTaiSanTongHopSearchModel.TEN_DON_VI;
        ...
        private void rptTS_BCDA_04_TSDA_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
            //cấu hình chung
