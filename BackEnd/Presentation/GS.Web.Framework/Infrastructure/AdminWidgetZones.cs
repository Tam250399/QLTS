namespace GS.Web.Framework.Infrastructure
{
    public static partial class AdminWidgetZones
    {
        ...
        public static string ContractAttributeDetailsButtons => "admin_contract_attribute_details_buttons";
        public static string ContractAttributeDetailsInfoBottom => "admin_contract_attribute_details_info_bottom";
        public static string ContractAttributeDetailsInfoTop => "admin_contract_attribute_details_info_top";
        public static string ContractAttributeValueDetailsTop => "admin_contract_attribute_value_details_top";
        public static string ContractAttributeDetailsValuesTop => "admin_contract_attribute_details_values_top";
        public static string ContractAttributeDetailsValuesBottom => "admin_contract_attribute_details_values_bottom";
        public static string ContractAttributeValueDetailsBottom => "admin_contract_attribute_value_details_bottom";
        public static string ContractAttributeValueDetailsButtons => "admin_contract_attribute_value_details_buttons";
        ...
        public static string TaskAttributeDetailsButtons => "admin_task_attribute_details_buttons";
        public static string TaskAttributeDetailsInfoTop => "admin_task_attribute_details_info_top";
        public static string TaskAttributeDetailsInfoBottom => "admin_task_attribute_details_info_bottom";
        public static string TaskAttributeDetailsValuesTop => "admin_task_attribute_details_values_top";
        public static string TaskAttributeDetailsValuesBottom => "admin_task_attribute_details_values_bottom";
        public static string TaskAttributeValueDetailsTop => "admin_task_attribute_value_details_top";
        public static string TaskAttributeValueDetailsBottom => "admin_task_attribute_value_details_bottom";
        public static string TaskAttributeValueDetailsButtons => "admin_task_attribute_value_details_buttons";
