...
{
    public partial class rptTS_BCQH_MAU03_QUYDAT_MDSD
    {
		...
		public rptTS_BCQH_MAU03_QUYDAT_MDSD(
		...
		private void rptTS_BCQH_MAU03_QUYDAT_MDSD_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			tieude.Text = "Phụ lục III"+ "\r\n" + "QUỸ ĐẤT CHIA THEO NHÓM MỤC ĐÍCH SỬ DỤNG"+"\r\n"+"(Thời điểm báo cáo: "+_baoCaoTaiSanTongHopSearchModel.NgayKetThuc.toDateVNString()+ ")";
		}

		private void tableCell35_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCQH_MAU03_QUYDAT_MDSD _thisrow = GetCurrentRow() as TS_BCQH_MAU03_QUYDAT_MDSD;
			if (_thisrow != null)
			{
				Stt += 1;
				tableCell35.Text = Stt.ToString() + "- " + _thisrow.TEN_LOAI_TAI_SAN;
			}
		}
