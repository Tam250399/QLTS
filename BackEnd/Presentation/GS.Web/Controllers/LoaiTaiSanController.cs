...
namespace GS.Web.Controllers
{
	...
	public partial class LoaiTaiSanController : BaseWorksController
	{
		#region Fields
		...
		{
			if (!_quyenService.Authorize(StandardPermissionProvider.USERQLDMLoaiTaiSan))
		...
		public virtual IActionResult List(LoaiTaiSanSearchModel searchModel)
		{
			...
			//prepare model
			var model = _itemModelFactory.PrepareLoaiTaiSanListModel(searchModel);
			//session
