...
{
	public partial class rptTS_BCCT_01D_DK_TSNN
	{
		...
		private void tableCell104_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCCT_01D_DK_TSNN _row = GetCurrentRow() as TS_BCCT_01D_DK_TSNN;
			if (_row != null)
			{
		...
		private void rptTS_BCCT_01D_DK_TSNN_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		private void tableCell73_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
		...
		{
			//TS_BCCT_01D_DK_TSNN _rowC = GetCurrentRow() as TS_BCCT_01D_DK_TSNN;
			//TS_BCCT_01D_DK_TSNN _rowN = GetNextRow() as TS_BCCT_01D_DK_TSNN;
		...
		{
			label13.Text = "ĐVT cho: Số lượng là: Cái, khuôn viên; Diện tích đất - nhà là: " + _baoCaoTaiSanChiTietSearchModel.DonViDienTich.ToStringDonViDienTich() + ";Giá trị là: " + _baoCaoTaiSanChiTietSearchModel.DonViTien.ToStringDonViTien() + ".";
		}
