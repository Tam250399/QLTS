...
{
    public partial class CCDC_SuaChuaBaoDuong
    {
        private readonly BaoCaoTaiSanChiTietSearchModel _baoCaoTaiSanChiTietSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public CCDC_SuaChuaBaoDuong(BaoCaoTaiSanChiTietSearchModel baoCaoTaiSanChiTietSearchModel,
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            CenterHeader.Text = "BÁO CÁO TÌNH HÌNH SỬA CHỮA CÔNG CỤ, DỤNG CỤ";
            ngayANDbophan.Text = "Kỳ báo cáo từ ngày: " + this._baoCaoTaiSanChiTietSearchModel.NgayBatDau.toDateVNString() + " đến ngày " + _baoCaoTaiSanChiTietSearchModel.NgayKetThuc.toDateVNString() +"\r\n" /*+ _donViBoPhan*/;
        ...
        //{
        //    BaoCaoSuaChua _rowC = GetCurrentRow() as BaoCaoSuaChua;
        //    BaoCaoSuaChua _rowN = GetNextRow() as BaoCaoSuaChua;
        ...
        {
            var row = GetCurrentRow() as BaoCaoSuaChua;
            if (row == null)
            {
