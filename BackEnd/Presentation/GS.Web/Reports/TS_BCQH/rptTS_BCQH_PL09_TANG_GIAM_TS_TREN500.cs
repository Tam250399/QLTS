...
namespace GS.Web.Reports.TS_BCQH
{
    public partial class rptTS_BCQH_PL09_TANG_GIAM_TS_TREN500
    {
		...
		private void rptTS_BCQH_PL09_TANG_GIAM_TS_TREN500_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
            //cấu hình chung
		...
		{
            lbngaybaocao.Text = "(Tính đến ngày " + _baoCaoTaiSanTongHopSearchModel.NgayKetThuc.toDateVNString() + ")";
        }
