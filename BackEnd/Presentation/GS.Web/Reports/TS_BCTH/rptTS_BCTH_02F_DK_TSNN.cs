...
{
    public partial class rptTS_BCTH_02F_DK_TSNN
    {
        ...
        {
            TS_BCTH_02F_DK_TSNN _row = GetCurrentRow() as TS_BCTH_02F_DK_TSNN;
        ...
        {
            TS_BCTH_02F_DK_TSNN row = GetCurrentRow() as TS_BCTH_02F_DK_TSNN;
            TS_BCTH_02F_DK_TSNN _row = row ?? new TS_BCTH_02F_DK_TSNN();
        ...
        #endregion
        private void rptTS_BCTH_02F_DK_TSNN_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
        ...
        {
            TS_BCTH_02F_DK_TSNN _rowC = GetCurrentRow() as TS_BCTH_02F_DK_TSNN;
            TS_BCTH_02F_DK_TSNN _rowN = GetNextRow() as TS_BCTH_02F_DK_TSNN;
        ...
        private void GroupHeader_DonViId_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
		...
		private void GhiChu_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCTH_02F_DK_TSNN _row = GetCurrentRow() as TS_BCTH_02F_DK_TSNN;
			if (_row != null && _row.NGUYEN_GIA == _row.LUY_KE)
			{
				var _this = sender as XRTableCell;
        ...
        private void tableCell21_AfterPrint(object sender, EventArgs e)
        {
