...
{
    public partial class rptTS_BCQH_MAU09_DAT_SD
    {
        private readonly BaoCaoTaiSanTongHopSearchModel _baoCaoTaiSanTongHopSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        private Int32 Stt;
        public rptTS_BCQH_MAU09_DAT_SD(BaoCaoTaiSanTongHopSearchModel baoCaoTaiSanTongHopSearchModel,
        ...
        private void rptTS_BCQH_MAU09_DAT_SD_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
        ...
        {
            TS_BCQH_MAU09_DAT_SD _thisrow = GetCurrentRow() as TS_BCQH_MAU09_DAT_SD;
            if (_thisrow != null)
            {
                Stt += 1;
                tableCell15.Text = Stt.ToString() + ". " + _thisrow.TEN_2;
            }
        }
