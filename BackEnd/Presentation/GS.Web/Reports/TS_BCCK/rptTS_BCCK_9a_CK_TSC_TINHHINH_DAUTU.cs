...
{
    public partial class rptTS_BCCK_9a_CK_TSC_TINHHINH_DAUTU
    {
		private readonly BaoCaoTaiSanChiTietSearchModel _baoCaoTaiSanChiTietSearchModel;
		private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
		private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        private int sttLyDoBienDong;
        private int sttLoaiTaiSan;

		public rptTS_BCCK_9a_CK_TSC_TINHHINH_DAUTU(
			...
			)
		{
            ...
            this.sttLoaiTaiSan = 0;
            this.sttLyDoBienDong = 0;
        }
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            lblNamBaoCao.Text = "NĂM " + _baoCaoTaiSanChiTietSearchModel.NamBaoCao;
            lblDieuKienBaoCao.Text = _baoCaoTaiSanChiTietSearchModel.StringLoaiTaiSan.ToStringLoaiHinhTaiSanFromString();
        }

        private void rptTS_BCCK_9a_CK_TSC_TINHHINH_DAUTU_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
        ...
        {
            //TS_BCCK_09A_CK_TSC _rowC = GetCurrentRow() as TS_BCCK_09A_CK_TSC;
            //TS_BCCK_09A_CK_TSC _rowN = GetNextRow() as TS_BCCK_09A_CK_TSC;
		...
		{
            TS_BCCK_09A_CK_TSC _row = GetCurrentRow() as TS_BCCK_09A_CK_TSC;
            if (_row != null && _row.CAP_1 != null)
            {
                sttLyDoBienDong += 1;
                var _thisCell = (sender as XRTableCell);
                _thisCell.Text = sttLyDoBienDong.ConvertIntToRomanNumber();
            }
        }
		...
		private void tableCell42_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
            ...
            if (_row != null && _row.CAP_1 != null)
            {
                sttLoaiTaiSan += 1;
                var _thisCell = (sender as XRTableCell);
                _thisCell.Text = sttLoaiTaiSan.ToString();
            }
        }
