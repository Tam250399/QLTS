...
{
    public partial class rptTS_BCCK_9d_CK_TSC_XULY_TS
    {
        ...
        public rptTS_BCCK_9d_CK_TSC_XULY_TS(
        ...
        {
            TS_BCCK_09D_CK_TSC _rowC = GetCurrentRow() as TS_BCCK_09D_CK_TSC;
            TS_BCCK_09D_CK_TSC _rowN = GetNextRow() as TS_BCCK_09D_CK_TSC;
        ...
        private void rptTS_BCCK_9d_CK_TSC_XULY_TS_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
		...
		{
            TS_BCCK_09D_CK_TSC _row = GetCurrentRow() as TS_BCCK_09D_CK_TSC;
