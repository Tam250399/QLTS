...
{
    public partial class rptTS_BCDA_02H_TS_TSDA
    {
        private readonly BaoCaoTaiSanTongHopSearchModel _baoCaoTaiSanTongHopSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public rptTS_BCDA_02H_TS_TSDA(BaoCaoTaiSanTongHopSearchModel baoCaoTaiSanTongHopSearchModel,
        ...
        private void rptTS_BCDA_02H_TS_TSDA_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        {
            GS.Core.Domain.BaoCaos.TS_BCDA.TS_BCDA_02H_TS_TSDA _thisrow = GetCurrentRow() as GS.Core.Domain.BaoCaos.TS_BCDA.TS_BCDA_02H_TS_TSDA;
            var _row = (sender as GroupHeaderBand);
        ...
        private void tenphanloai_Draw(object sender, DrawEventArgs e)
        {
            GS.Core.Domain.BaoCaos.TS_BCDA.TS_BCDA_02H_TS_TSDA _thisrow = GetCurrentRow() as GS.Core.Domain.BaoCaos.TS_BCDA.TS_BCDA_02H_TS_TSDA;
            if (_thisrow != null)
            {
        ...
        {
            GS.Core.Domain.BaoCaos.TS_BCDA.TS_BCDA_02H_TS_TSDA _row = GetCurrentRow() as GS.Core.Domain.BaoCaos.TS_BCDA.TS_BCDA_02H_TS_TSDA;
            if (_row != null)
            {
                var _thisCell = (sender as XRTableCell);
