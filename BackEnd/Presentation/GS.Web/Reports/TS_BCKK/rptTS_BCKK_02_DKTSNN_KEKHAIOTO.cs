...
{
	public partial class rptTS_BCKK_02_DKTSNN_KEKHAIOTO
	{
		...
		public rptTS_BCKK_02_DKTSNN_KEKHAIOTO(
		...
		private void rptTS_BCKK_02_DKTSNN_KEKHAIOTO_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		{
			TS_BCKK_02_DK_TSNN _row = GetCurrentRow() as TS_BCKK_02_DK_TSNN;
