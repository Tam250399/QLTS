...
namespace GS.Services.Common
{
    ...
    public partial class MaintenanceService : IMaintenanceService
    {
        ...
        {
            var path = _fileProvider.GetAbsolutePath(GSCommonDefaults.DbBackupsPath);
        ...
        public virtual IList<string> GetAllBackupFiles()
        {
            ...
            {
                throw new GSException("Backup directory not exists");
            }

            return _fileProvider.GetFiles(path, $"*.{GSCommonDefaults.DbBackupFileExtension}")
        ...
        public virtual void BackupDatabase()
        {
            ...
            var fileName = $"{GetBackupDirectoryPath()}database_{DateTime.Now:yyyy-MM-dd-HH-mm-ss}_{CommonHelper.GenerateRandomDigitCode(10)}.{GSCommonDefaults.DbBackupFileExtension}";
