...
{
    public partial class rptTS_BCQH_MAU10_TS_TREN500_MDSD
    {
		...
		public rptTS_BCQH_MAU10_TS_TREN500_MDSD(
		...
		private void rptTS_BCQH_MAU10_TS_TREN500_MDSD_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		{
            label3.Text = "Đơn vị báo cáo: " + _baoCaoTaiSanTongHopSearchModel.TEN_DON_VI;
			tieude.Text = "Phụ lục IX"+"\r\n" + "TÀI SẢN CỐ ĐỊNH KHÁC THEO MỤC ĐÍCH SỬ DỤNG" + "\r\n" + "(Thời điểm báo cáo: " + _baoCaoTaiSanTongHopSearchModel.NgayKetThuc.toDateVNString() + ")";
		}

		private void tableCell25_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCQH_MAU10_TS_TREN500_MDSD _thisrow = GetCurrentRow() as TS_BCQH_MAU10_TS_TREN500_MDSD;
			if (_thisrow != null)
			{
				Stt += 1;
