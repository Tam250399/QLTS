...
namespace GS.Web.Reports.TS_BCKK
{
	public partial class rptTS_BCKK_04b_DKTSC_KEKHAIOTO
	{
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			lblNgayBaoCao.Text = $"Ngày báo cáo: {_baoCaoTaiSanChiTietSearchModel.NgayBaoCao.toDateVNString()}";
		}
		...
		{
			//TS_BCKK_04B_DK_TSC _row = GetCurrentRow() as TS_BCKK_04B_DK_TSC;
			//if (_row != null)
			//{
		...
		{
			tableCell45.Text = "Tổng cộng";
		}

		private void tableCell167_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCKK_04B_DK_TSC _row = GetCurrentRow() as TS_BCKK_04B_DK_TSC;
			if (_row != null)
				(sender as XRTableCell).Text = $"{lblRecord.Summary.GetResult()} - {_row.TEN_2}";
