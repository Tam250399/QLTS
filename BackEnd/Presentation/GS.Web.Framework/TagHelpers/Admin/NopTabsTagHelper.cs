...
namespace GS.Web.Framework.TagHelpers.Admin
{
    ...
    public class GSTabsTagHelper : TagHelper
    {
        ...
        public GSTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<GSTabContextItem>();
            context.Items.Add(typeof(GSTabsTagHelper), tabContext);
    ...
    public class GSTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public GSTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<GSTabContextItem>)context.Items[typeof(GSTabsTagHelper)];
            tabContext.Add(new GSTabContextItem()
            {
