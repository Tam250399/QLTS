...
{
    public partial class CCDC_HongMat
    {
        private readonly BaoCaoTaiSanChiTietSearchModel _baoCaoTaiSanChiTietSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public CCDC_HongMat(BaoCaoTaiSanChiTietSearchModel baoCaoTaiSanChiTietSearchModel,
        ...
        {
            leftHeader.Text = "Cơ quan quản lý cấp trên: " + (_cauHinhBaoCaoModel.DonViKhaiThac != null ? _cauHinhBaoCaoModel.DonViKhaiThac : _baoCaoTaiSanChiTietSearchModel.TEN_BO_NGANH) + "\r\n" + "Tên đơn vị: " + _baoCaoTaiSanChiTietSearchModel.TEN_DON_VI + "\r\n" + "Mã đơn vị: " + _baoCaoTaiSanChiTietSearchModel.MA_DON_VI;
            CenterHeader.Text = "TÌNH HÌNH HỎNG, MẤT CÔNG CỤ, DỤNG CỤ";
        ...
        //{
        //    BaoCaoHongMat _rowC = GetCurrentRow() as BaoCaoHongMat;
        //    BaoCaoHongMat _rowN = GetNextRow() as BaoCaoHongMat;
        ...
        {
            var row = GetCurrentRow() as BaoCaoHongMat;
            if (row == null)
            {
