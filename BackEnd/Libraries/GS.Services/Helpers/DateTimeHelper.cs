...
namespace GS.Services.Helpers
{
    ...
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        public virtual TimeZoneInfo GetCustomerTimeZone(NguoiDung customer)
        {
            ...
            //if (customer != null)
            //    timeZoneId = _genericAttributeService.GetAttribute<string>(customer, GSCustomerDefaults.TimeZoneIdAttribute);
        ...
        public virtual TimeZoneInfo DefaultStoreTimeZone
        {
            ...
            set
            {
                ...
                _settingService.SaveCauHinh(_dateTimeSettings);
            }
        }
        ...
        public virtual TimeZoneInfo CurrentTimeZone
        {
            ...
            set
            {
                ...
                //    GSCustomerDefaults.TimeZoneIdAttribute, timeZoneId);
            }
        }
