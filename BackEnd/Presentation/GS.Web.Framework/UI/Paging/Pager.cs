...
namespace GS.Web.Framework.UI.Paging
{
    /// <summary>
    ...
    public partial class Pager : IHtmlContent
    {
        ...
        public virtual string GenerateHtmlString()
        {
            ...
            if (showTotalSummary && (model.TotalPages > 0))
            {
                ...
                links.Append(string.Format(_nhanHienThiService.GetGiaTri("Pager.CurrentPage"), model.PageIndex + 1, model.TotalPages, model.TotalItems));
                links.Append("</li>");
            }
            if (showPagerItems && (model.TotalPages > 1))
            {
                if (showFirst)
                {
                    ...
                    {
                        links.Append(CreatePageLink(1, _nhanHienThiService.GetGiaTri("Pager.First"), firstPageCssClass));
                    }
                }
                if (showPrevious)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.PageIndex, _nhanHienThiService.GetGiaTri("Pager.Previous"), previousPageCssClass));
                    }
                }
                ...
                if (showNext)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.PageIndex + 2, _nhanHienThiService.GetGiaTri("Pager.Next"), nextPageCssClass));
                    }
                }
                if (showLast)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.TotalPages, _nhanHienThiService.GetGiaTri("Pager.Last"), lastPageCssClass));
                    }
                }
            }
