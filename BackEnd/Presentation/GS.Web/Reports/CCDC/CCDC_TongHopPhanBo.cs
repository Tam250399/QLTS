...
{
    public partial class CCDC_TongHopPhanBo
    {
        private readonly BaoCaoTaiSanChiTietSearchModel _baoCaoTaiSanChiTietSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public CCDC_TongHopPhanBo(BaoCaoTaiSanChiTietSearchModel baoCaoTaiSanChiTietSearchModel,
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            CenterHeader.Text = "BẢNG TÍNH PHÂN BỔ CÔNG CỤ, DỤNG CỤ ";
            ngayANDbophan.Text = "Kỳ báo cáo : " + $"{_baoCaoTaiSanChiTietSearchModel.NgayBaoCao.Value.Month}/{_baoCaoTaiSanChiTietSearchModel.NgayBaoCao.Value.Year}";
        }
        ...
        //{
        //    BaoCaoPhanBo _rowC = GetCurrentRow() as BaoCaoPhanBo;
        //    BaoCaoPhanBo _rowN = GetNextRow() as BaoCaoPhanBo;
        ...
        {
            var row = GetCurrentRow() as BaoCaoPhanBo;
            if (row == null)
            {
