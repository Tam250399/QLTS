...
namespace GS.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        private static readonly IGSFileProvider _fileProvider;
        ...
        public static void MarkPluginAsInstalled(string systemName)
        {
            ...
            var filePath = _fileProvider.MapPath(GSPluginDefaults.InstalledPluginsFilePath);
        ...
        public static void SavePluginDescriptor(PluginDescriptor pluginDescriptor)
        {
            ...
            var filePath = _fileProvider.Combine(_fileProvider.GetDirectoryName(pluginDescriptor.OriginalAssemblyFile), GSPluginDefaults.DescriptionFileName);
            if (!_fileProvider.FileExists(filePath))
        ...
        public static string GetLogoUrl(PluginDescriptor pluginDescriptor)
        {
            ...
            var logoExtension = GSPluginDefaults.SupportedLogoImageExtensions
                .FirstOrDefault(ext => _fileProvider.FileExists(_fileProvider.Combine(pluginDirectory, $"{GSPluginDefaults.LogoFileName}.{ext}")));
            ...
            var logoUrl = $"{webHelper.GetStoreLocation()}plugins/{_fileProvider.GetDirectoryNameOnly(pluginDirectory)}/{GSPluginDefaults.LogoFileName}.{logoExtension}";
            return logoUrl;
        }
