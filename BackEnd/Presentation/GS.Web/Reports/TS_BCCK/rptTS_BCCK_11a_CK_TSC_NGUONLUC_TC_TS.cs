...
{
    public partial class rptTS_BCCK_11a_CK_TSC_NGUONLUC_TC_TS
    {
        ...
        public rptTS_BCCK_11a_CK_TSC_NGUONLUC_TC_TS(
        ...
        int STT = 0;
        private void rptTS_BCCK_11a_CK_TSC_NGUONLUC_TC_TS_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            tieude.Text = "CÔNG KHAI TÌNH HÌNH ĐẦU TƯ XÂY DỰNG, MUA SẮM, GIAO THUÊ, TÀI SẢN CÔNG"+"\r\n" +"NĂM " + _baoCaoTaiSanChiTietSearchModel.NamBaoCao;
        ...
        private void Cap1_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11A_CK_TSC _row = GetCurrentRow() as TS_BCCK_11A_CK_TSC;
        ...
        private void sttcap1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void TenLoaiHinhTS_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11A_CK_TSC _row = GetCurrentRow() as TS_BCCK_11A_CK_TSC;
            if (_row != null)
            {
        ...
        private void tableCell185_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11A_CK_TSC _row = GetCurrentRow() as TS_BCCK_11A_CK_TSC;
            var _this = sender as XRTableCell;
            if (_row != null)
        ...
        private void tableCell39_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11A_CK_TSC _row = GetCurrentRow() as TS_BCCK_11A_CK_TSC;
            var _this = sender as XRTableCell;
            if (_row != null)
