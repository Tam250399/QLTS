    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapLocalizedRoute("HomePage", "",
                new { controller = "Home", action = "IndexSSO" });
            ...
            routeBuilder.MapLocalizedRoute("Logout", "logout/",
                new { controller = "NguoiDung", action = "Logout" });

            
            routeBuilder.MapLocalizedRoute("TaiSan", "TaiSan",
                new { controller = "TaiSan", action = "NhapLieu" });
            routeBuilder.MapLocalizedRoute("AppWork", "AppWork",
                new { controller = "AppWork", action = "Index" });
            routeBuilder.MapLocalizedRoute("BaoCao", "BaoCao",
                new { controller = "BaoCao", action = "Index" });
            routeBuilder.MapLocalizedRoute("YeuCau", "YeuCau",
                new { controller = "YeuCau", action = "ListCapNhatSoTienBanThanhLy" });
            //routeBuilder.MapLocalizedRoute("KhaiThac", "KhaiThac/{hinhthuckhaithac?}",
            //    new { controller = "KhaiThac", action = "List" });
            routeBuilder.MapLocalizedRoute("TaiSanChoThue", "TaiSanChoThue",
                new { controller = "TaiSanChoThue", action = "List" });


            //báo cáo
            routeBuilder.MapLocalizedRoute("LoaiBaoCao", "bao-cao/{LoaiBaoCao}",
                new { controller = "Report", action = "TS_BC" });
            ...
            ////Bien dong tang nguyen gia tai san
            //routeBuilder.MapLocalizedRoute("BienDong_TangNguyenGiaTaiSan",
            //    "TangNguyenGiaTaiSan",
            //    new { controller = "TaiSan", action = "ListBienDongTaiSan", @loaiLyDoId = (int)enumLOAI_LY_DO_TANG_GIAM.BIEN_DONG_TANG_GIA_TRI },
