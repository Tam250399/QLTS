...
{
	public class TS_BCDA_04A_TRUSODENGHIXULY:BaseViewEntity
	{
		...
		public decimal? NHA_NGUYEN_GIA_VIEN_TRO { get; set; }
		public decimal? NHA_NGUYEN_GIA_ODA { get; set; }
		...
		public decimal? NHA_HDSN_LDLK { get; set; }
		public decimal? NHA_SD_HON_HOP { get; set; }
