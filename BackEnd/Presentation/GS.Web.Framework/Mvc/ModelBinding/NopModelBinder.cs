...
{
    /// <summary>
    /// Represents model binder for the binding models inherited from the BaseGSModel
    /// </summary>
    public class GSModelBinder : ComplexTypeModelBinder
    {
        #region Ctor
        ...
        public GSModelBinder(IDictionary<ModelMetadata, IModelBinder> propertyBinders, ILoggerFactory loggerFactory)
        ...
        protected override object CreateModel(ModelBindingContext bindingContext)
        {
            ...
            if (model is BaseGSModel)
                (model as BaseGSModel).BindModel(bindingContext);
