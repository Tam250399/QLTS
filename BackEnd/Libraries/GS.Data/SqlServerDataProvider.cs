...
namespace GS.Data
{
    ...
    public partial class SqlServerDataProvider : IDataProvider
    {
        ...
        public virtual void InitializeDatabase()
        {
            ...
            //create indexes
            context.ExecuteSqlScriptFromFile(fileProvider.MapPath(GSDataDefaults.SqlServerIndexesFilePath));

            //create stored procedures 
            context.ExecuteSqlScriptFromFile(fileProvider.MapPath(GSDataDefaults.SqlServerStoredProceduresFilePath));
        }
    ...
    public partial class OracleDataProvider : IDataProvider
    {
        #region Methods
