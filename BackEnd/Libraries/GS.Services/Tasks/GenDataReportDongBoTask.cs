...
namespace GS.Services.Tasks
{
    ...
    public class GenDataReportDongBoTask : IJob
    {
        ...
        Task IJob.Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                if (GenDataReportDongBoTask.IsRunning && schheduleTask.ENABLED.GetValueOrDefault(true))
                    return null;
                ...
                var content = client.OpenRead(_config.UrlQLTSC + "NoBase/GetDataReport?isDongBo=true");
