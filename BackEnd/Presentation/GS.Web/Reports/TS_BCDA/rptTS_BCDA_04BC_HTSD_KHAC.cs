...
namespace GS.Web.Reports.TS_BCDA
{
    public partial class rptTS_BCDA_04BC_HTSD_KHAC
    {
		...
		{
			chuthich.Text = $"ĐVT cho: Số lượng là: Cái, chiếc; Giá trị là: {_baoCaoTaiSanTongHopSearchModel.DonViTien.ToStringDonViTien()}.";
		}
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			centerHeader.Text = $"BÁO CÁO HIỆN TRẠNG SỬ DỤNG TÀI SẢN CỐ ĐỊNH (KHÔNG PHẢI LÀ NHÀ, ĐẤT, XE Ô TÔ) \r\n Thời điểm báo cáo: {_baoCaoTaiSanTongHopSearchModel.NgayKetThuc.toDateVNString()}";
		}

		private void rptTS_BCDA_04BC_HTSD_KHAC_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
