...
{
    public enum enumHienTrang
    {
        DAT_TRU_SO_LAM_VIEC = 72,
        NHA_TRU_SO_LAM_VIEC = 82
    }
    public partial class YeuCauChiTiet : BaseEntity
    {
        public YeuCauChiTiet()
        {

        }
        public YeuCauChiTiet(YeuCauChiTiet obj)
        {
            this.YEU_CAU_ID = obj.YEU_CAU_ID;
            ...
            this.NGAY_BAN_THANH_LY = obj.NGAY_BAN_THANH_LY;
        ...
        public YeuCauChiTiet(BienDongChiTiet obj)
        {
            this.YEU_CAU_ID = obj.BIEN_DONG_ID;
            this.HINH_THUC_MUA_SAM_ID = obj.HINH_THUC_MUA_SAM_ID;
            this.MUC_DICH_SU_DUNG_ID = obj.MUC_DICH_SU_DUNG_ID;
            this.NHAN_HIEU = obj.NHAN_HIEU;
            this.SO_HIEU = obj.SO_HIEU;
