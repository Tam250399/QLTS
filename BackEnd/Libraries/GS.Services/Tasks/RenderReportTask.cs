...
{
    public class RenderReportTask : IJob
    {
        ...
        Task IJob.Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                if (RenderReportTask.IsRunning && schheduleTask.ENABLED.GetValueOrDefault(true))
                    return null;
                //IsRunning = true;
                ...
                var content = client.DownloadString(_config.UrlRenderReport);
