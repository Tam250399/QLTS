...
{
    public partial class rptTS_BCTH_02E_DK_TSNN
    {
        ...
        {
            TS_BCTH_02E_DK_TSNN _row = GetCurrentRow() as TS_BCTH_02E_DK_TSNN;
        ...
        private void tableCell70_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCTH_02E_DK_TSNN _row = GetCurrentRow() as TS_BCTH_02E_DK_TSNN;
            STT_TS_2 = 0;
        ...
        {
            TS_BCTH_02E_DK_TSNN row = GetCurrentRow() as TS_BCTH_02E_DK_TSNN;
            TS_BCTH_02E_DK_TSNN _row = row ?? new TS_BCTH_02E_DK_TSNN();
        ...
        #endregion
        private void rptTS_BCTH_02E_DK_TSNN_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
        ...
        {
            TS_BCTH_02E_DK_TSNN _rowC = GetCurrentRow() as TS_BCTH_02E_DK_TSNN;
            TS_BCTH_02E_DK_TSNN _rowN = GetNextRow() as TS_BCTH_02E_DK_TSNN;
        ...
        private void tyLeConLai_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCTH_02E_DK_TSNN _row = GetCurrentRow() as TS_BCTH_02E_DK_TSNN;
            if (_row != null)
            {
        ...
        int stt = 0;
        int stt1 = 0;
        private void tableCell88_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCTH_02E_DK_TSNN _row = GetCurrentRow() as TS_BCTH_02E_DK_TSNN;
            if (_row != null)
            {
