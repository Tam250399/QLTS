...
namespace GS.Web.Reports.TS_CDKT
{
	public partial class CDKT_KiemKeTaiSanPhongBan
	{
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			centerHeader.Text = "BÁO CÁO KIỂM KÊ TÀI SẢN CỐ ĐỊNH THEO PHÒNG BAN \r\n  Năm " + _baoCaoTaiSanChiTietSearchModel.NgayKetThuc?.Year;
		...
		{
			var _label = (sender as XRTableCell);
			var _currentRow = GetCurrentRow() as BaoCaoKiemKeTaiSan;
