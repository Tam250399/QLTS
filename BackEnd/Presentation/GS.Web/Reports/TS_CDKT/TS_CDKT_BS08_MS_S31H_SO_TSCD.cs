...
namespace GS.Web.Reports.TS_CDKT
{
	public partial class TS_CDKT_BS08_MS_S31H_SO_TSCD
	{
		...
		private void TS_CDKT_BS08_MS_S31H_SO_TSCD_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		private void tableCell46_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			_this.Text = "Năm: " + _baoCaoTaiSanChiTietSearchModel.NamBaoCao;
		}
		...
		private void tableCell46_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			var _currenCell = sender as XRTableCell;
			if (_currenCell != null) _currenCell.Text = $"Năm: {_baoCaoTaiSanChiTietSearchModel.NamBaoCao}";
		}
