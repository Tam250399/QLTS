...
namespace GS.Web.Reports.TS_BCQH
{
    public partial class rptTS_BCQH_PL02_TANG_GIAM_TSNN
    {
        ...
        {
            TS_BCQH_PL02_TANG_GIAM_TSNN _row = GetCurrentRow() as TS_BCQH_PL02_TANG_GIAM_TSNN;
			if (_row != null)
			{
        ...
        private void tableCell63_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCQH_PL02_TANG_GIAM_TSNN _thisrow = GetCurrentRow() as TS_BCQH_PL02_TANG_GIAM_TSNN;
			if (_thisrow != null)
			{
				switch (_thisrow.LOAI_HINH_DON_VI)
				{
					case (int)enumLoaiDonVi.CO_QUAN_NN:
						tenLoaiDonVi.Text = "a- " + _thisrow.TEN_LOAI_HINH_DON_VI;
						break;
					case (int)enumLoaiDonVi.DON_VI_SU_NGHIEP:
						tenLoaiDonVi.Text = "b- " + _thisrow.TEN_LOAI_HINH_DON_VI;
						break;
					case (int)enumLoaiDonVi.TO_CHUC:
						tenLoaiDonVi.Text = "c- " + _thisrow.TEN_LOAI_HINH_DON_VI;
						break;
					case (int)enumLoaiDonVi.BAN_QUAN_LY_DU_AN:
						tenLoaiDonVi.Text = "d- " + _thisrow.TEN_LOAI_HINH_DON_VI;
						break;
				}
		...
		private void rptTS_BCQH_PL02_TANG_GIAM_TSNN_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		{
			tieude.Text = "TỔNG HỢP TÌNH HÌNH TĂNG, GIẢM TÀI SẢN CÔNG NĂM " + _baoCaoTaiSanTongHopSearchModel.NgayKetThuc.Value.Year;
		}
