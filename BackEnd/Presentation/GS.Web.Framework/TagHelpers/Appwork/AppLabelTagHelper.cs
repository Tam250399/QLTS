...
namespace GS.Web.Framework.TagHelpers.Appwork
{
    ...
    public class AppLabelTagHelper : TagHelper
    {
        ...
        public AppLabelTagHelper(IHtmlGenerator generator, IWorkContext workContext, INhanHienThiService NhanHienThiService)
        {
            Generator = generator;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //generate label
            var tagBuilder = Generator.GenerateLabel(ViewContext, For.ModelExplorer, For.Name, null, new { @class = "col-form-label text-sm-right", @style = "width:100%" });
            if (tagBuilder != null)
            {
