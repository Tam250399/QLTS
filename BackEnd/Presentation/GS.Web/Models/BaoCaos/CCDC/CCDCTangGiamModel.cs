...
{
    public class CCDCTangGiamModel
    {
        
    }
    public class TangGiamCongCuSearchModel
    {
        public TangGiamCongCuSearchModel()
        {
            TangOrGiam = 0;
            DDLDonViBoPhan = new List<SelectListItem>();
            DDLNhomCongCu = new List<SelectListItem>();
            DDLTangOrGiam = new List<SelectListItem>();
        ...
        public Decimal TangOrGiam { get; set; }
