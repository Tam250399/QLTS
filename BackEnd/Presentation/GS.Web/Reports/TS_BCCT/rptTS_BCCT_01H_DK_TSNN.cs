...
namespace GS.Web.Reports.TS_BCCT
{
	public partial class rptTS_BCCT_01H_DK_TSNN
	{
			...
			)
		{
			...
			this.PrintingSystem.BeforePagePaint += PrintingSystem_BeforePagePaint;
			
		}

		private void PrintingSystem_BeforePagePaint(object sender, PagePaintEventArgs e)
		{
			this.PrintingSystem.SetCommandVisibility(new PrintingSystemCommand[] {
				PrintingSystemCommand.ExportRtf, PrintingSystemCommand.ExportMht,
				PrintingSystemCommand.ExportCsv, PrintingSystemCommand.ExportGraphic,
				PrintingSystemCommand.ExportHtm, PrintingSystemCommand.ExportTxt , PrintingSystemCommand.ShowNextPage},
		CommandVisibility.None);
		}


		private void rptTS_BCCT_01H_DK_TSNN_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			lb_DieuKienBaoCao.Text = "Kỳ báo cáo: Từ ngày " + _baoCaoTaiSanChiTietSearchModel.NgayBatDau.toDateVNString() + " đến ngày " + _baoCaoTaiSanChiTietSearchModel.NgayKetThuc.toDateVNString() + "\r\n" + _baoCaoTaiSanChiTietSearchModel.StringLoaiTaiSan.ToStringLoaiHinhTaiSanFromString() + "\r\n" + "Chi tiết bậc báo cáo: " + _baoCaoTaiSanChiTietSearchModel.BacTaiSan + "; Lý do:" + _baoCaoTaiSanChiTietSearchModel.BanOrThanhLy.ToStringBanOrThanhLy();
		}
		...
		{
			TS_BCCT_01Gand01H_DK_TSNN _row = GetCurrentRow() as TS_BCCT_01Gand01H_DK_TSNN;
			if (_row != null)
			{
		...
		{
			//TS_BCCT_01Gand01H_DK_TSNN _rowC = GetCurrentRow() as TS_BCCT_01Gand01H_DK_TSNN;
			//TS_BCCT_01Gand01H_DK_TSNN _rowN = GetNextRow() as TS_BCCT_01Gand01H_DK_TSNN;
		...
		{
			lb_DonVi.Text = "ĐVT cho: Số lượng là: Cái, khuôn viên; Giá trị là: " + _baoCaoTaiSanChiTietSearchModel.DonViTien.ToStringDonViTien() + ".";
		}
