...
{
    public partial class rptTS_BCTH_TT_CUNGCAP_TAICHINH
    {
		...
		public rptTS_BCTH_TT_CUNGCAP_TAICHINH(
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			label7.Text = "ĐVT: " + _baoCaoTaiSanTongHopSearchModel.DonViTien.ToStringDonViTien() + ".";
		...
		{
			TS_BCTH_TT_CUNGCAP_TAICHINH _row = GetCurrentRow() as TS_BCTH_TT_CUNGCAP_TAICHINH;
			if (_row != null)
			{
