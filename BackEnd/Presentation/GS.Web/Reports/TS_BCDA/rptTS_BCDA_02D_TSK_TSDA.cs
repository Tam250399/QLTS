...
{
    public partial class rptTS_BCDA_02D_TSK_TSDA
    {
		...
		private int Cap4;
		private int Cap5;
		public rptTS_BCDA_02D_TSK_TSDA(BaoCaoTaiSanTongHopSearchModel baoCaoTaiSanTongHopSearchModel,
        ...
        private void rptTS_BCDA_02D_TSK_TSDA_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        {
            TS_BCDA_02D_TSK_TSDA _thisrow = GetCurrentRow() as TS_BCDA_02D_TSK_TSDA;
        ...
        {
            TS_BCDA_02D_TSK_TSDA _row = GetCurrentRow() as TS_BCDA_02D_TSK_TSDA;
            if (_row != null)
            {
                var _thisCell = (sender as XRTableCell);
