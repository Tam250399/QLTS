...
{
    public class ThongTinTaiSanDongBoModel : BaseGSEntityModel
    {
        public ThongTinTaiSanDongBoModel()
        {
        ...
        public List<BDDBModel> LST_BIEN_DONG_DB { get; set; }//danh sách biến động - map bảng BD_BIEN_DONG + BD_BIEN_DONG_CHI_TIET
    ...
    public class TaiSanMayMocDBModel : BaseGSModel
    {
        public String PHU_KIEN_JSON { get; set; }
        public String THONG_SO_KY_THUAT { get; set; }
    }
    public class TaiSanVoHinhDBModel : BaseGSModel
    {
        public String THONG_SO_KY_THUAT { get; set; }
    }
    public class TaiSanKhac : BaseGSModel
    {
    ...
    public class BienDongDBModel : BaseGSModel
    {
    ...
    public class TaiSanHienTrangSuDungDBModel : BaseGSModel
    {
    ...
    public class TaiSanNguonVonDBModel : BaseGSModel
    {
