...
{
	public partial class rptTS_BCCK_10c_CK_TSC_XL_TS
	{
		...
		int STT_4 = 0;
		int STT_5 = 0;
		public rptTS_BCCK_10c_CK_TSC_XL_TS(
        ...
        {
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
		...
		private void GroupHeader_LTaiSanCap2__BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _thisRow = (sender as GroupHeaderBand);
			if (_row == null)
		...
		private void GroupHeader_LTaiSanCap3__BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _thisRow = (sender as GroupHeaderBand);
			if (_row == null)
		...
		private void GroupHeader_LTaiSanCap4__BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _thisRow = (sender as GroupHeaderBand);
			if (_row == null)
		...
		private void GroupHeader_LTaiSanCap5__BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _thisRow = (sender as GroupHeaderBand);
			if (_row == null)
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			lblDieuKienBaoCao.Text = $"NĂM {_baoCaoTaiSanChiTietSearchModel.NamBaoCao} \r\n {_baoCaoTaiSanChiTietSearchModel.StringLoaiTaiSan.ToStringLoaiHinhTaiSanFromString()}\r\n  Chi tiết bậc tài sản: {_baoCaoTaiSanChiTietSearchModel.BacTaiSan}; Chi tiết bậc đơn vị: {_baoCaoTaiSanChiTietSearchModel.BacDonVi}";
		}
		private void rptTS_BCCK_10C_CK_TSC_DAUTU_XD_THUE_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//c?u hình chung
        ...
        private void tableCell638_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null)
        ...
        private void tableCell637_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null)
        ...
        private void tableCell307_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null)
        ...
        private void tableCell172_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10C_CK_TSC _row = GetCurrentRow() as TS_BCCK_10C_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null)
