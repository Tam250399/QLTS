...
namespace GS.Web.Reports.TS_BCQH
{
    public partial class rptTS_BCQH_TH_QUAN_LY_SD_NHA_TSC
    {
        ...
        {
            TS_BCQH_TH_QUAN_LY_SD_NHA_TSC _row = GetCurrentRow() as TS_BCQH_TH_QUAN_LY_SD_NHA_TSC;
            if (_row != null)
            {
