...
{
    public partial class rptTS_BCDA_02E_KT_TSDA
    {
        private readonly BaoCaoTaiSanTongHopSearchModel _baoCaoTaiSanTongHopSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public rptTS_BCDA_02E_KT_TSDA(BaoCaoTaiSanTongHopSearchModel baoCaoTaiSanTongHopSearchModel,
        ...
        {           
            ...
            if (_baoCaoTaiSanTongHopSearchModel.MauSo == 2)
            {
                ...
                mauso.Text = "Mẫu số: 02E-2-KT/TSDA";
            }
            else
            {
                maubaocao.Text = "(Báo cáo tổng hợp)";
                mauso.Text = "Mẫu số: 02E-1-KT/TSDA";
            }
        ...
        {
            TS_BCDA_02E_KT_TSDA _thisrow = GetCurrentRow() as TS_BCDA_02E_KT_TSDA;
            var _row = (sender as GroupHeaderBand);
        ...
        {
            TS_BCDA_02E_KT_TSDA _row = GetCurrentRow() as TS_BCDA_02E_KT_TSDA;
            if (_row != null)
            {
                var _thisCell = (sender as XRTableCell);
        ...
        private void rptTS_BCDA_02E_KT_TSDA_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
