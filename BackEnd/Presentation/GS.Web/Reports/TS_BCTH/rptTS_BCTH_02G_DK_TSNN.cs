...
{
    public partial class rptTS_BCTH_02G_DK_TSNN
	{
		...
		{
			TS_BCTH_02G_DK_TNSS _row = GetCurrentRow() as TS_BCTH_02G_DK_TNSS;
		...
		private void _Cap1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCTH_02G_DK_TNSS _row = GetCurrentRow() as TS_BCTH_02G_DK_TNSS;
			var _thisRow = (sender as GroupHeaderBand);
			if (_row == null)
		...
		private void _Cap2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCTH_02G_DK_TNSS row = GetCurrentRow() as TS_BCTH_02G_DK_TNSS;
			TS_BCTH_02G_DK_TNSS _row = row ?? new TS_BCTH_02G_DK_TNSS();
		...
		private void _Cap3_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCTH_02G_DK_TNSS row = GetCurrentRow() as TS_BCTH_02G_DK_TNSS;
			TS_BCTH_02G_DK_TNSS _row = row ?? new TS_BCTH_02G_DK_TNSS();
		...
		private void _Cap4_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCTH_02G_DK_TNSS row = GetCurrentRow() as TS_BCTH_02G_DK_TNSS;
			TS_BCTH_02G_DK_TNSS _row = row ?? new TS_BCTH_02G_DK_TNSS();
		...
		private void _Cap5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCTH_02G_DK_TNSS row = GetCurrentRow() as TS_BCTH_02G_DK_TNSS;
			TS_BCTH_02G_DK_TNSS _row = row ?? new TS_BCTH_02G_DK_TNSS();
		...
		{
			TS_BCTH_02G_DK_TNSS _rowC = GetCurrentRow() as TS_BCTH_02G_DK_TNSS;
			TS_BCTH_02G_DK_TNSS _rowN = GetNextRow() as TS_BCTH_02G_DK_TNSS;
