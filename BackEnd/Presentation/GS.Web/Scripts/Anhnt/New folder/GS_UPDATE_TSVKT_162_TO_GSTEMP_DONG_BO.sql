create or replace FUNCTION GS_UPDATE_TSVKT_162_TO_GSTEMP_DONG_BO 
(
...
--
    ...
    ) LOOP biendongJsonGuid := raw_to_guid(LPAD(r_bd_vkt.BD_KHAC_ID, 32, '0'));
    BEGIN
    ...
    biendongJsonJson := biendongJsonJson||
        ...
        "NGUYEN_GIA":' || rtrim(to_char(r_bd_vkt.NGUYEN_GIA_NS + r_bd_vkt.NGUYEN_GIA_KHAC, 'FM9999999999999999999999990.99'), '.') || ',
        ...
        "THONG_SO_KY_THUAT":"' ||  GS_STRING_TO_STRINGJSON(r_bd_vkt.THONG_SO_KT) || '",
        ...
        "KH_GIA_TINH_KHAU_HAO":' || rtrim(to_char( r_bd_vkt.KH_NGUYEN_GIA_NS + r_bd_vkt.KH_NGUYEN_GIA_KHAC + r_bd_vkt.KH_NGUYEN_GIA_ODA + r_bd_vkt.KH_NGUYEN_GIA_VIEN_TRO, 'FM9999999999999999999999990.99'), '.') || ',
        "KH_GIA_TRI_CON_LAI":' || rtrim(to_char(r_bd_vkt.KH_GIA_TRI_CON_LAI, 'FM9999999999999999999999990.99'), '.') || ',
        "KH_THANG_CON_LAI":' || r_bd_vkt.SO_THANG_CON_SU_DUNG || ',
        "HS_KHAC":"' || GS_STRING_TO_STRINGJSON(r_bd_vkt.SO_QD) || '"},';
    nguonVonJson := nguonVonJson ||
        '{"NGUON_VON_ID":1, "GIA_TRI":' || r_bd_vkt.NGUYEN_GIA_NS||', "BIEN_DONG_GUID":"' || biendongJsonGuid|| '"}, 
        {"NGUON_VON_ID":3, "GIA_TRI":' || r_bd_vkt.NGUYEN_GIA_KHAC||', "BIEN_DONG_GUID":"' || biendongJsonGuid || '"},';
    ...
    END;
        ...
        SET gstemp.tai_san_json = REPLACE(dataJson,'":,','":null,'),
            ...
            gstemp.NGUYEN_GIA_BAN_DAU = nguyen_gia_ban_dau,
...
END GS_UPDATE_TSVKT_162_TO_GSTEMP_DONG_BO;