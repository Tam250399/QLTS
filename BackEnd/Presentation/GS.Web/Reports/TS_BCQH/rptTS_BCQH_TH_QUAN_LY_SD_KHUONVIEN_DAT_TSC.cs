...
{
    public partial class rptTS_BCQH_TH_QUAN_LY_SD_KHUONVIEN_DAT_TSC
    {
        private readonly BaoCaoTaiSanTongHopSearchModel _baoCaoTaiSanTongHopSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public rptTS_BCQH_TH_QUAN_LY_SD_KHUONVIEN_DAT_TSC(
        ...
        int sttLoaiDonVi = 1;
        int sttDV = 0;
        private void sttDonVi_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCQH_TH_QUAN_LY_SD_KHUONVIEN_DAT_TSC _row = GetCurrentRow() as TS_BCQH_TH_QUAN_LY_SD_KHUONVIEN_DAT_TSC;
            if (_row != null)
            {
        ...
        {
            chuthich.Text = "ĐVT cho: Diện tích là: " + _baoCaoTaiSanTongHopSearchModel.DonViDienTich.ToStringDonViDienTich() + "; Số lượng là: Cái, Khuôn viên; Giá trị là: Tỷ đồng";
        }
