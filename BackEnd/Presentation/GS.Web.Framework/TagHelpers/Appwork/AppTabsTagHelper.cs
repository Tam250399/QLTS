...
namespace GS.Web.Framework.TagHelpers.Appwork
{
    ...
    /// nop-tabs tag helper
    /// </summary>
    [HtmlTargetElement("app-tabs", Attributes = IdAttributeName)]
    public class AppTabsTagHelper : TagHelper
    {
        ...
        public AppTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<AppTabContextItem>();
            context.Items.Add(typeof(AppTabsTagHelper), tabContext);
    ...
    /// "nop-tab tag helper
    /// </summary>
    [HtmlTargetElement("app-tab", ParentTag = "app-tabs", Attributes = NameAttributeName)]
    public class AppTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public AppTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var a = new TagBuilder("a")
            {
                Attributes =
                {
                    ...
                    new KeyValuePair<string, string>("class", "nav-link"),
                }
            };
            if (tabNameToSelect == Name)
                a.AddCssClass("active show");
            ...
            //add to context
            var tabContext = (List<AppTabContextItem>)context.Items[typeof(AppTabsTagHelper)];
            tabContext.Add(new AppTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class AppTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
