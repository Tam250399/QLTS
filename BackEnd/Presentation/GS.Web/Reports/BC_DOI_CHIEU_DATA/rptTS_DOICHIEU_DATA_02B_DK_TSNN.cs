...
{
    public partial class rptTS_DOICHIEU_DATA_02B_DK_TSNN
	{
		...
		public rptTS_DOICHIEU_DATA_02B_DK_TSNN(
        ...
        {
			TS_DOICHIEU_DATA_02B_DK_TSNN _row = GetCurrentRow() as TS_DOICHIEU_DATA_02B_DK_TSNN;
        ...
        private void GroupHeader4_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			...
			if (_row != null)
			{
				int? Cap_2 = _row.CAP_2;
				if (Cap_2 == 0 || _baoCaoTaiSanTongHopSearchModel.BacTaiSan < 2)
				{
					var _thisRow = (sender as GroupHeaderBand);
					_thisRow.Visible = false;
				}
        ...
        private void GroupHeader5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			...
			if (_row != null)
			{
				int? Cap_3 = _row.CAP_3 ?? 0;
				if (Cap_3 == 0 || _baoCaoTaiSanTongHopSearchModel.BacTaiSan < 3)
				{
					var _thisRow = (sender as GroupHeaderBand);
					_thisRow.Visible = false;
				}
        ...
        private void GroupHeader6_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			...
			if (_row != null)
			{
				int Cap_4 = _row.CAP_4 ?? 0;
				if (Cap_4 == 0 || _baoCaoTaiSanTongHopSearchModel.BacTaiSan < 4)
				{
					var _thisRow = (sender as GroupHeaderBand);
					_thisRow.Visible = false;
				}
		...
		{
			TS_DOICHIEU_DATA_02B_DK_TSNN _rowC = GetCurrentRow() as TS_DOICHIEU_DATA_02B_DK_TSNN;
			TS_DOICHIEU_DATA_02B_DK_TSNN _rowN = GetNextRow() as TS_DOICHIEU_DATA_02B_DK_TSNN;
		...
		{
			chuthich.Text = "ĐVT cho: Diện tích đất là: " + _baoCaoTaiSanTongHopSearchModel.DonViDienTich.ToStringDonViDienTich() + "; Diện tích nhà là: " + _baoCaoTaiSanTongHopSearchModel.DonViDienTich.ToStringDonViDienTich() + ";";
		}
