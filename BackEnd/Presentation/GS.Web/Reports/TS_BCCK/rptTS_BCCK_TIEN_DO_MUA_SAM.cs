...
{
    public partial class rptTS_BCCK_TIEN_DO_MUA_SAM
    {
        private readonly BaoCaoTaiSanTongHopSearchModel _baoCaoTaiSanTongHopSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public rptTS_BCCK_TIEN_DO_MUA_SAM(BaoCaoTaiSanTongHopSearchModel baoCaoTaiSanTongHopSearchModel,
        ...
        private void rptTS_BCCK_TIEN_DO_MUA_SAM_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            tieude.Text = "BÁO CÁO TIẾN ĐỘ MUA SẮM TÀI SẢN NĂM " + _baoCaoTaiSanTongHopSearchModel.NamBaoCao
        ...
        {
            TS_BCCK_TDMS _thisrow = GetCurrentRow() as TS_BCCK_TDMS;
            var _row = (sender as GroupHeaderBand);
            //if (_thisrow != null && (_thisrow.PHAN_LOAI_ID == (int)enumLOAI_HINH_TAI_SAN_BAO_CAO.TREN_500 || _thisrow.PHAN_LOAI_ID == (int)enumLOAI_HINH_TAI_SAN_BAO_CAO.DUOI_500) && _thisrow.CAP_1 > 0 && _baoCaoTaiSanTongHopSearchModel.BacTaiSan > 1)
            //{
            //    _row.Visible = true;
            //}
            //else
        ...
        {
            TS_BCCK_TDMS _row = GetCurrentRow() as TS_BCCK_TDMS;
            if (_row != null)
            {
                var _thisCell = (sender as XRTableCell);
        ...
        private int STT = 0;
        private void STT_DETAIL_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_TDMS _thisrow = GetCurrentRow() as TS_BCCK_TDMS;
            var _row = (sender as XRTableCell);
            if (_thisrow != null)
            {
                STT += 1;
                _row.Text = STT.ToString();
            }
        }
