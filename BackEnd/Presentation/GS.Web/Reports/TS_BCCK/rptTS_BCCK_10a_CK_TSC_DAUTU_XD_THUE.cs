...
namespace GS.Web.Reports.TS_BCCK
{
	public partial class rptTS_BCCK_10a_CK_TSC_DAUTU_XD_THUE
	{
		...
		int STT_4 = 0;
		int STT_5 = 0;
		public rptTS_BCCK_10a_CK_TSC_DAUTU_XD_THUE(
		...
		{
			TS_BCCK_10A_CK_TSC _row = GetCurrentRow() as TS_BCCK_10A_CK_TSC;
		...
		private void ten1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			if (TEN_1 != null)
			{
				sttLoaiHinhTS += 1;
				var _thisCell = (sender as XRTableCell);
				_thisCell.Text = /*sttLoaiHinhTS.ToString() + ". " +*/ TEN_1;
			}
		}
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			//label1.Text = $"Chi tiết bậc tài sản: {_baoCaoTaiSanChiTietSearchModel.BacTaiSan}; Chi tiết bậc đơn vị: {_baoCaoTaiSanChiTietSearchModel.BacDonVi}";
		}
		private void rptTS_BCCK_10a_CK_TSC_DAUTU_XD_THUE_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			//cấu hình chung
		...
		private void tableCell72_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
		...
		private void sttdv2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCCK_10A_CK_TSC _row = GetCurrentRow() as TS_BCCK_10A_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null && _row.tree_level_dv >= 2)
			{
				Cap3 = 0;
				Cap4 = 0;
				Cap5 = 0;
		...
		private void sttdv3_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCCK_10A_CK_TSC _row = GetCurrentRow() as TS_BCCK_10A_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null && _row.tree_level_dv >= 3)
			{
				Cap4 = 0;
				Cap5 = 0;
			}
		...
		private void sttdv4_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCCK_10A_CK_TSC _row = GetCurrentRow() as TS_BCCK_10A_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null &&  _row.tree_level_dv >= 4)
			{
				Cap5 = 0;
			}
		...
		private void tableCell83_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void tableCell94_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10A_CK_TSC _row = GetCurrentRow() as TS_BCCK_10A_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null)
        ...
        private void tableCell105_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10A_CK_TSC _row = GetCurrentRow() as TS_BCCK_10A_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null)
        ...
        private void tableCell116_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			TS_BCCK_10A_CK_TSC _row = GetCurrentRow() as TS_BCCK_10A_CK_TSC;
			var _this = sender as XRTableCell;
			if (_row != null)
        ...
        private void TenLoaiHinhTaiSan_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
			...
			if (_row != null)
			{
				...
				{
					var TenLoaiHinh = _baoCaoTaiSanChiTietSearchModel.lstNhanHienThi.Where(c => c.Key == (new enumNHAN_HIEN_THI_LOAI_HINH_TS().GetType().FullName) + "." + ((enumNHAN_HIEN_THI_LOAI_HINH_TS)_row.LOAI_HINH_TAI_SAN_ID).ToString()).Select(c => c.Value).FirstOrDefault();
