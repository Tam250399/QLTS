...
{
    public partial class rptTS_BCDA_02A_THC_TSDA
    {
        private readonly BaoCaoTaiSanTongHopSearchModel _baoCaoTaiSanTongHopSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public rptTS_BCDA_02A_THC_TSDA(BaoCaoTaiSanTongHopSearchModel baoCaoTaiSanTongHopSearchModel,
        ...
        private void rptTS_BCDA_02A_THC_TSDA_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        {
            TS_BCDA_02A_THC_TSDA _thisrow = GetCurrentRow() as TS_BCDA_02A_THC_TSDA;
            if (_thisrow != null)
            {
                phanloai.Text = ((int)_thisrow.phan_loai_tai_san).ToLoaiTaiSanBaoCao();
            }
        }
        ...
        private void Cap1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if(_thisrow!=null && (_thisrow.phan_loai_tai_san ==(int)enumLOAI_HINH_TAI_SAN_BAO_CAO.TREN_500 || _thisrow.phan_loai_tai_san == (int)enumLOAI_HINH_TAI_SAN_BAO_CAO.DUOI_500|| _thisrow.phan_loai_tai_san == (int)enumLOAI_HINH_TAI_SAN_BAO_CAO.KHAC) && _thisrow.CAP_1 > 0 && _baoCaoTaiSanTongHopSearchModel.BacTaiSan > 1)
            {
                _row.Visible = true;
            }
            else
        ...
        {
            TS_BCDA_02A_THC_TSDA _row = GetCurrentRow() as TS_BCDA_02A_THC_TSDA;
            if (_row != null)
            {
                var _thisCell = (sender as XRTableCell);
		...
		private int index = 0;
		private void tableCell93_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			var _thisCell = (sender as XRTableCell);
			if (_thisCell != null)
			{
