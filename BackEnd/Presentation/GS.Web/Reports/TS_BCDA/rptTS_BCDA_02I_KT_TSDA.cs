...
{
    public partial class rptTS_BCDA_02I_KT_TSDA
    {
        private readonly BaoCaoTaiSanTongHopSearchModel _baoCaoTaiSanTongHopSearchModel;
        private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
        private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
        public rptTS_BCDA_02I_KT_TSDA(BaoCaoTaiSanTongHopSearchModel baoCaoTaiSanTongHopSearchModel,
        ...
        private void rptTS_BCDA_02I_KT_TSDA_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        {
            TS_BCDA_02I_KT_TSDA _thisrow = GetCurrentRow() as TS_BCDA_02I_KT_TSDA;
            var _row = (sender as GroupHeaderBand);
        ...
        {
            TS_BCDA_02I_KT_TSDA _row = GetCurrentRow() as TS_BCDA_02I_KT_TSDA;
            if (_row != null)
            {
                var _thisCell = (sender as XRTableCell);
