...
{
    public partial class rptTS_BCTH_02B_DK_TSNN
    {
        ...
        {
			TS_BCTH_02B_DK_TSNN _row = GetCurrentRow() as TS_BCTH_02B_DK_TSNN;
		...
		{
			TS_BCTH_02B_DK_TSNN _rowC = GetCurrentRow() as TS_BCTH_02B_DK_TSNN;
			TS_BCTH_02B_DK_TSNN _rowN = GetNextRow() as TS_BCTH_02B_DK_TSNN;
