...
namespace GS.Services.Tasks
{
    ...
    public class GenDataReportTask : IJob
    {
        ...
        Task IJob.Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                if (GenDataReportTask.IsRunning && schheduleTask.ENABLED.GetValueOrDefault(true))
                    return null;
                ...
                var content = client.OpenRead(_config.UrlQLTSC + "NoBase/GetDataReport");
