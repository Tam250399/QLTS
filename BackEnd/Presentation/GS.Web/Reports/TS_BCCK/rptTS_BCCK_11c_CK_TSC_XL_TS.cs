...
{
    public partial class rptTS_BCCK_11c_CK_TSC_XL_TS
    {
        ...
        int STT_4 = 0;
        int STT_5 = 0;
        public rptTS_BCCK_11c_CK_TSC_XL_TS(
        ...
        private void rptTS_BCCK_11c_CK_TSC_XL_TS_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            tieude.Text = "CÔNG KHAI TÌNH HÌNH XỬ LÝ TÀI SẢN CÔNG \r\nNĂM " + _baoCaoTaiSanChiTietSearchModel.NamBaoCao;
        ...
        {
            TS_BCCK_11C_CK_TSC _row = GetCurrentRow() as TS_BCCK_11C_CK_TSC;
        ...
        int STT = 0;
        private void tableCell436_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11C_CK_TSC _row = GetCurrentRow() as TS_BCCK_11C_CK_TSC;
            var _this = sender as XRTableCell;
            if (_row != null)
        ...
        private void tableCell64_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11C_CK_TSC _row = GetCurrentRow() as TS_BCCK_11C_CK_TSC;
            var _this = sender as XRTableCell;
            if (_row != null)
        ...
        private void tableCell118_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11C_CK_TSC _row = GetCurrentRow() as TS_BCCK_11C_CK_TSC;
            var _this = sender as XRTableCell;
            if (_row != null)
        ...
        private void tableCell145_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11C_CK_TSC _row = GetCurrentRow() as TS_BCCK_11C_CK_TSC;
            var _this = sender as XRTableCell;
            if (_row != null)
        ...
        private void tableCell440_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            TS_BCCK_11C_CK_TSC _row = GetCurrentRow() as TS_BCCK_11C_CK_TSC;
            if (_row != null)
            {
