...
namespace GS.WebApi.Models.TaiSan
{
    ...
    public class TSDBModel : BaseGSApiModel
    {
        public TSDBModel()
        {
        ...
        public List<HaoMonTaiSanDBModel> LST_HAO_MON { get; set; }
        public List<KhauHaoTaiSanDBModel> LST_KHAU_HAO { get; set; }
    ...
    public class TSMayMocDBModel : BaseGSApiModel
    {
        public String PHU_KIEN_JSON { get; set; }
        public String THONG_SO_KY_THUAT { get; set; }
    }
    public class TSVoHinhDBModel : BaseGSApiModel
    {
        public String THONG_SO_KY_THUAT { get; set; }
    }
    public class TSKhac : BaseGSApiModel
    {
    ...
    public class BDDBModel : BaseGSApiModel
    {
        public BDDBModel()
        {
        ...
        [Required(ErrorMessage = ("LY_DO_BIEN_DONG_MA null"))]
        ...
        public Decimal? KH_GIA_TINH_KHAU_HAO_NGUON_ODA { get; set; }
        public Decimal? KH_GIA_TINH_KHAU_HAO_NGAN_SACH { get; set; }
        public Decimal? KH_GIA_TINH_KHAU_HAO_NGUON_KHAC { get; set; }
        public Decimal? KH_GIA_TINH_KHAU_HAO_NGUON_VIEN_TRO { get; set; }
        ...
        public decimal? NV_NGUON_ODA { get; set; }
        #endregion
        ...
        public bool? LA_TS_HET_HM_CO_THAY_DOI_NG { get; set; }
        public decimal? TY_LE_HM_NEW { get; set; }
        public decimal? TY_LE_KH_NEW { get; set; }
        public decimal? SO_NAM_SD_CON_LAI { get; set; }
    }
    public class TSHienTrangSuDungDBModel : BaseGSApiModel
    {
    ...
    public class TSNguonVonDBModel : BaseGSApiModel
    {
    ...
    public class ResultTS
    {
        public ResultTS()
        {
            this.ListTaiSan = new List<TSDBModel>();
        }
        public List<TSDBModel> ListTaiSan { get; set; }
        public int Total { get; set; }
        public int TotalPage { get; set; }
    }
    public class TaiSan_HTSD
    {
        public decimal ID { get; set; }
        public decimal GIA_TRI_NUMBER { get; set; }
        public bool GIA_TRI_CHECKBOX { get; set; }
    }
    public class TrangThaiDBNamModel
    {
    ...
    public class KhauHaoTaiSanDBModel : BaseGSApiModel
    {
    ...
    public class HaoMonTaiSanDBModel : BaseGSApiModel
    {
