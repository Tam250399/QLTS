...
namespace GS.Web.Areas.Admin.Infrastructure.Mapper.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        public static TCacheEntity ToModelCache<TCacheEntity>(this BaseEntity entity) where TCacheEntity : BaseCacheEntity
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));

            return entity.Map<TCacheEntity>();
        }
        /// <summary>
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BaseGSEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : BaseEntity where TModel : BaseGSEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseGSEntityModel model) where TEntity : BaseEntity
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <summary>
        /// Execute a mapping from the view entity to a new entity
        /// </summary>
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <param name="view">Model to map from</param>
        /// <returns>Mapped entity</returns>
        public static TEntity ToEntity<TEntity>(this BaseViewEntity view) where TEntity : BaseEntity
        {
            if (view == null)
                throw new ArgumentNullException(nameof(view));

            return view.Map<TEntity>();
        }
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToCauHinhModel<TModel>(this ICauHinh settings) where TModel : BaseGSModel, ICauHinhModel
        {
            if (settings == null)
        ...
        public static TCauHinh ToCauHinh<TCauHinh, TModel>(this TModel model, TCauHinh settings)
            where TCauHinh : class, ICauHinh where TModel : BaseGSModel, ICauHinhModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToPluginModel<TModel>(this IPlugin plugin) where TModel : BaseGSModel, IPluginModel
        {
            if (plugin == null)
        ...
        public static TModel ToPluginModel<TModel>(this PluginDescriptor pluginDescriptor, TModel model = null)
            where TModel : BaseGSModel, IPluginModel
        {
        ...
        #endregion
        #region Mapping orther
        /// <summary>
        /// Mapping tài sản đồng bộ với tài sản sản import bằng file
        /// </summary>
        ...
        /// <returns></returns>
        public static TDestination ToTaiSan<TSource,TDestination>(this TSource source, TDestination destination) where TSource :class where TDestination:class
        {
