...
namespace GS.Web.Reports.TS_BCQH
{
    public partial class rptTS_BCQH_PL08_OTO_VSD
    {
		...
		{
            tieude.Text = "XE Ô TÔ SỬ DỤNG VƯỢT THỜI HẠN QUY ĐỊNH (Tính đến ngày " + "\r\n" + _baoCaoTaiSanTongHopSearchModel.NgayKetThuc.toDateVNString() + ")";
        }

		private void rptTS_BCQH_PL08_OTO_VSD_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
            //cấu hình chung
