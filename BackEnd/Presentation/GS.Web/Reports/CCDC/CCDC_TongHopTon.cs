...
{
    public partial class CCDC_TongHopTon
    {
		private readonly BaoCaoTaiSanChiTietSearchModel _baoCaoTaiSanChiTietSearchModel;
		private readonly CauHinhBaoCaoModel _cauHinhBaoCaoModel;
		private readonly CauHinhBaoCaoChungModel _cauHinhBaoCaoChungModel;
		public CCDC_TongHopTon(BaoCaoTaiSanChiTietSearchModel baoCaoTaiSanChiTietSearchModel,
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			CenterHeader.Text = "BÁO CÁO TỔNG HỢP TỒN CÔNG CỤ, DỤNG CỤ";
			ngayANDbophan.Text = "Kỳ báo cáo từ ngày: " + _baoCaoTaiSanChiTietSearchModel.NgayBatDau.toDateVNString() + " đến " + _baoCaoTaiSanChiTietSearchModel.NgayKetThuc.toDateVNString() + " \r\n " /*+ "Phòng ban, bộ phận sử dụng: " + _donvibophan*/;
		}
