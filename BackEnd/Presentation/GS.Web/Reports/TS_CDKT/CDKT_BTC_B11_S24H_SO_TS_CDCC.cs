...
namespace GS.Web.Reports.TS_CDKT
{
    public partial class CDKT_BTC_B11_S24H_SO_TS_CDCC
    {
        ...
        private void CDKT_BTC_B11_S24H_SO_TS_CDCC_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //cấu hình chung
        ...
        private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            lblDieuKien.Text = "Tên đơn vị, Phòng, Ban (hoặc người sử dụng): "+_baoCaoTaiSanChiTietSearchModel.TenListDonViBoPhan + "\r\n" + "Loại công cụ, dụng cụ (hoặc nhóm công cụ, dụng cụ): "+_baoCaoTaiSanChiTietSearchModel.TenListNhomCongCu;
        }
