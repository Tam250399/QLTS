...
namespace GS.Web.Reports.TS_BCKK
{
    public partial class rptTS_BCKK_04c_DKTSNN_KEKHAITSKHAC
    {
		...
		{
			//TS_BCKK_04C_DK_TSC _row = GetCurrentRow() as TS_BCKK_04C_DK_TSC;
			//if (_row != null)
			//{
		...
		private void tableCell1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_BCKK_04C_DK_TSC _row = GetCurrentRow() as TS_BCKK_04C_DK_TSC;
			if (_row != null)
				(sender as XRTableCell).Text = $"{lblRecord.Summary.GetResult()} - {_row.TAI_SAN_TEN}";
		}
	}
}
