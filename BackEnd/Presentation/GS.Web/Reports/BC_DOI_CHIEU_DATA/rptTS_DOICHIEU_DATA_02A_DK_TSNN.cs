...
{
	public partial class rptTS_DOICHIEU_DATA_02A_DK_TSNN
	{
		...
		public rptTS_DOICHIEU_DATA_02A_DK_TSNN(
		...
		{
			TS_DOICHIEU_DATA_02A_DK_TSNN _row = GetCurrentRow() as TS_DOICHIEU_DATA_02A_DK_TSNN;
		...
		private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			if (_row != null)
			{
				if (_baoCaoTaiSanTongHopSearchModel.BacTaiSan < 5 || _baoCaoTaiSanTongHopSearchModel.IsHideDetail )
				{
		...
		private void ReportHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			switch (_baoCaoTaiSanTongHopSearchModel.MauSo)
			{
				...
				case 2:
					...
					ngayandbactaisan.Text = ngayandbactaisan.Text + "\r\n" + "Loại hình đơn vị: " + _baoCaoTaiSanTongHopSearchModel.TenLoaiHinhDonVi;
					break;
				case 3:
		...
		//	}
		//}
		private void tableCell147_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_DOICHIEU_DATA_02A_DK_TSNN _row = GetCurrentRow() as TS_DOICHIEU_DATA_02A_DK_TSNN;
			...
			if (_row != null)
			{
				...
				{
					case 1:
						_this.Text = $"{STT_TS}. Đất khuôn viên";
						break;
					case 2:
						_this.Text = $"{STT_TS}. Nhà";
						break;
					case 4:
						_this.Text = $"{STT_TS}. Xe ô tô";
						break;
					case 500:
						_this.Text = $"{STT_TS}. Tài sản khác trên 500 triệu đồng";
						break;
					case 501:
						_this.Text = $"{STT_TS}. Tài sản khác dưới 500 triệu đồng";
						break;
		...
		{
			TS_DOICHIEU_DATA_02A_DK_TSNN _rowC = GetCurrentRow() as TS_DOICHIEU_DATA_02A_DK_TSNN;
			TS_DOICHIEU_DATA_02A_DK_TSNN _rowN = GetNextRow() as TS_DOICHIEU_DATA_02A_DK_TSNN;
		...
		private void GroupHeader3_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_DOICHIEU_DATA_02A_DK_TSNN _row = GetCurrentRow() as TS_DOICHIEU_DATA_02A_DK_TSNN;
			var _thisRow = (sender as GroupHeaderBand);
			if (_row != null && (_row.CAP_1 == 0 || _baoCaoTaiSanTongHopSearchModel.BacTaiSan < 2))
			{
				_thisRow.Visible = false;
			}
			else
		...
		private void GroupHeader12_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			TS_DOICHIEU_DATA_02A_DK_TSNN _row = GetCurrentRow() as TS_DOICHIEU_DATA_02A_DK_TSNN;
